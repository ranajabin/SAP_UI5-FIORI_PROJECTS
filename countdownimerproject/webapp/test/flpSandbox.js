		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#countdowncountdownimerproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"countdowncountdownimerproject-display": {
								"semanticObject": "countdowncountdownimerproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=countdown.countdownimerproject",
									"url": sap.ui.require.toUrl("countdown/countdownimerproject")
								}
							}
						}
					}
