		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Records",
									"targetURL": "#jsnjsonmodelproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jsnjsonmodelproject-display": {
								"semanticObject": "jsnjsonmodelproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jsn.jsonmodelproject",
									"url": sap.ui.require.toUrl("jsn/jsonmodelproject")
								}
							}
						}
					}
