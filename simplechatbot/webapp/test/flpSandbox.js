		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat Bot",
									"targetURL": "#chatbotsimplechatbot-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chatbotsimplechatbot-display": {
								"semanticObject": "chatbotsimplechatbot",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chatbot.simplechatbot",
									"url": sap.ui.require.toUrl("chatbot/simplechatbot")
								}
							}
						}
					}
