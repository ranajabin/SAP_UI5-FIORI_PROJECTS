		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#calendarplanningcalendar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"calendarplanningcalendar-display": {
								"semanticObject": "calendarplanningcalendar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=calendar.planningcalendar",
									"url": sap.ui.require.toUrl("calendar/planningcalendar")
								}
							}
						}
					}
