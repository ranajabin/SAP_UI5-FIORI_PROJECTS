		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Stopwatch",
									"targetURL": "#watchstopwatch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"watchstopwatch-display": {
								"semanticObject": "watchstopwatch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=watch.stopwatch",
									"url": sap.ui.require.toUrl("watch/stopwatch")
								}
							}
						}
					}
