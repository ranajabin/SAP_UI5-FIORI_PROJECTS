		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table",
									"targetURL": "#tabledatefiltertable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tabledatefiltertable-display": {
								"semanticObject": "tabledatefiltertable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=table.datefiltertable",
									"url": sap.ui.require.toUrl("table/datefiltertable")
								}
							}
						}
					}
