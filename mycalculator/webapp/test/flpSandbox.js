		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator",
									"targetURL": "#calcmycalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"calcmycalculator-display": {
								"semanticObject": "calcmycalculator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=calc.mycalculator",
									"url": sap.ui.require.toUrl("calc/mycalculator")
								}
							}
						}
					}
