		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Stopwatch",
									"targetURL": "#watchstopwatchh-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"watchstopwatchh-display": {
								"semanticObject": "watchstopwatchh",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=watch.stopwatchh",
									"url": sap.ui.require.toUrl("watch/stopwatchh")
								}
							}
						}
					}
