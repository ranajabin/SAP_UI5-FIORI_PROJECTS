		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#Codingmycoding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Codingmycoding-display": {
								"semanticObject": "Codingmycoding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Coding.mycoding",
									"url": sap.ui.require.toUrl("Coding/mycoding")
								}
							}
						}
					}
