sap.ui.define([
    ...
    function (Controller, MessageToast, MessageBox) {
        ...
        return Controller.extend("person.persondetailsproject.controller.Login", {
            onInit: function () {
            },

            // Function to check the credentials of enrolled employee
            onpresslogin: function () {
                ...
                // Validations for correct username and password
            ...
            // Functions to navigate into last view/page
            onNavBack: function () {
                history.go(-1);
            }
        });
