		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#personpersondetailsproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"personpersondetailsproject-display": {
								"semanticObject": "personpersondetailsproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=person.persondetailsproject",
									"url": sap.ui.require.toUrl("person/persondetailsproject")
								}
							}
						}
					}
