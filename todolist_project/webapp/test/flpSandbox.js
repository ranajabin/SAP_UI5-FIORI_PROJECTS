		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "To Do List",
									"targetURL": "#todotodolistproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"todotodolistproject-display": {
								"semanticObject": "todotodolistproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=todo.todolistproject",
									"url": sap.ui.require.toUrl("todo/todolistproject")
								}
							}
						}
					}
