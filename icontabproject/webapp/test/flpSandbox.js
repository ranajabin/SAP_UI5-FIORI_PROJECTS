		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#Icontabicontabproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Icontabicontabproject-display": {
								"semanticObject": "Icontabicontabproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Icontab.icontabproject",
									"url": sap.ui.require.toUrl("Icontab/icontabproject")
								}
							}
						}
					}
