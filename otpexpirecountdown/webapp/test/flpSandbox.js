		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OTP",
									"targetURL": "#otpotpexpirecountdown-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"otpotpexpirecountdown-display": {
								"semanticObject": "otpotpexpirecountdown",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=otp.otpexpirecountdown",
									"url": sap.ui.require.toUrl("otp/otpexpirecountdown")
								}
							}
						}
					}
