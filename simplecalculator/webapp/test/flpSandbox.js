		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator",
									"targetURL": "#calcsimplecalculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"calcsimplecalculator-display": {
								"semanticObject": "calcsimplecalculator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=calc.simplecalculator",
									"url": sap.ui.require.toUrl("calc/simplecalculator")
								}
							}
						}
					}
