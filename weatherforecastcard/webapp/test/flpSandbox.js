		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cardprojectweatherforecastcard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cardprojectweatherforecastcard-display": {
								"semanticObject": "cardprojectweatherforecastcard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cardproject.weatherforecastcard",
									"url": sap.ui.require.toUrl("cardproject/weatherforecastcard")
								}
							}
						}
					}
