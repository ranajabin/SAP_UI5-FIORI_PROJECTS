		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#pollutionpollutiontracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pollutionpollutiontracker-display": {
								"semanticObject": "pollutionpollutiontracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pollution.pollutiontracker",
									"url": sap.ui.require.toUrl("pollution/pollutiontracker")
								}
							}
						}
					}
