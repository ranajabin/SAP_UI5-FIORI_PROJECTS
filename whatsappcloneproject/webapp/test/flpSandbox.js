		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Whatsapp",
									"targetURL": "#whatsappwhatsappcloneproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"whatsappwhatsappcloneproject-display": {
								"semanticObject": "whatsappwhatsappcloneproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=whatsapp.whatsappcloneproject",
									"url": sap.ui.require.toUrl("whatsapp/whatsappcloneproject")
								}
							}
						}
					}
